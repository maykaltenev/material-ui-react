...
// let portfolio_home__titleH1 = document.querySelector(".portfolio_home__title h1");
// let portfolio_home__titleHr = document.querySelector(".portfolio_home__title hr");
// let portfolio_home__title_trigger = document.querySelector(".portfolio_home__title img.trigger");
// let slider_inner = document.querySelector(".slider_inner")

// trigger.addEventListener('click', function () {
//     pagePortfolio.style.opacity = "1"
//     pagePortfolio.style.clipPath = 'polygon(0 100%, 100% 100%, 100% 0%, 0 0%)';
//     logoImg.addClass('out');
//     portfolio_home__titleH1.addClass('out')
//     portfolio_home__titleHr.addClass('out')
//     portfolio_home__title_trigger.addClass('out')
//     slider_inner.addClass('in')

//     setTimeout(function () {
//         slider_inner.addEventListener('click', function () {
//         }, 2500);
//     });
// }
// introComplete = false;
